...
#ifndef WINLIB_WINBASE_SEQUENCED_TASK_RUNNER_H_
#define WINLIB_WINBASE_SEQUENCED_TASK_RUNNER_H_

#include <memory>

#include "winbase\base_export.h"
#include "winbase\functional\callback.h"
#include "winbase\sequenced_task_runner_helpers.h"
...
class WINBASE_EXPORT SequencedTaskRunner : public TaskRunner {
 public:
...
#endif  // WINLIB_WINBASE_SEQUENCED_TASK_RUNNER_H_