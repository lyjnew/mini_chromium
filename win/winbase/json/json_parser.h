...
#ifndef WINLIB_WINBASE_JSON_JSON_PARSER_H_
#define WINLIB_WINBASE_JSON_JSON_PARSER_H_
...
#include "winbase\json\json_reader.h"
...
// of the next token.
class WINBASE_EXPORT JSONParser {
 public:
 ...
 private:
  ...
  class StringBuilder {
   ...
   private:
    ...
    // called.
    winbase::Optional<std::string> string_;
  };
...
WINBASE_EXPORT extern const char kUnicodeReplacementString[];

}  // namespace internal
}  // namespace winbase

#endif  // WINLIB_WINBASE_JSON_JSON_PARSER_H_