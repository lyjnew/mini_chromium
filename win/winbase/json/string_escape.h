...
#ifndef WINLIB_WINBASE_JSON_STRING_ESCAPE_H_
#define WINLIB_WINBASE_JSON_STRING_ESCAPE_H_
...
WINBASE_EXPORT bool EscapeJSONString(StringPiece str,
                                     bool put_in_quotes,
                                     std::string* dest);
...
WINBASE_EXPORT bool EscapeJSONString(StringPiece16 str,
                                     bool put_in_quotes,
                                     std::string* dest);

// Helper functions that wrap the above two functions but return the value
// instead of appending. |put_in_quotes| is always true.
WINBASE_EXPORT std::string GetQuotedJSONString(StringPiece str);
WINBASE_EXPORT std::string GetQuotedJSONString(StringPiece16 str);
...
WINBASE_EXPORT std::string EscapeBytesAsInvalidJSONString(StringPiece str,
                                                          bool put_in_quotes);

}  // namespace winbase

#endif  // WINLIB_WINBASE_JSON_STRING_ESCAPE_H_