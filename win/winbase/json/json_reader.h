...
#ifndef WINLIB_WINBASE_JSON_JSON_READER_H_
#define WINLIB_WINBASE_JSON_JSON_READER_H_
...
class WINBASE_EXPORT JSONReader {
 public:
...
#endif  // WINLIB_WINBASE_JSON_JSON_READER_H_