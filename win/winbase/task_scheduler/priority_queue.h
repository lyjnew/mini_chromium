...
#ifndef WINLIB_WINBASE_TASK_SCHEDULER_PRIORITY_QUEUE_H_
#define WINLIB_WINBASE_TASK_SCHEDULER_PRIORITY_QUEUE_H_
...
class WINBASE_EXPORT PriorityQueue {
 public:
  ...
  // operations.
  class WINBASE_EXPORT Transaction {
   public:
...
#endif  // WINLIB_WINBASE_TASK_SCHEDULER_PRIORITY_QUEUE_H_