...
#ifndef WINLIB_WINBASE_TASK_SCHEDULER_SCHEDULER_WORKER_STACK_H_
#define WINLIB_WINBASE_TASK_SCHEDULER_SCHEDULER_WORKER_STACK_H_
...
class WINBASE_EXPORT SchedulerWorkerStack {
 public:
  SchedulerWorkerStack();
  SchedulerWorkerStack(const SchedulerWorkerStack&) = delete;
  SchedulerWorkerStack& operator=(const SchedulerWorkerStack&) = delete;
  ~SchedulerWorkerStack();
...
#endif  // WINLIB_WINBASE_TASK_SCHEDULER_SCHEDULER_WORKER_STACK_H_