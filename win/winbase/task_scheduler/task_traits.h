...
#ifndef WINLIB_WINBASE_TASK_SCHEDULER_TASK_TRAITS_H_
#define WINLIB_WINBASE_TASK_SCHEDULER_TASK_TRAITS_H_
...
#include "winbase\task_scheduler\task_traits_details.h"
...
// - winbase::PlatformThread::Join
// - winbase::PlatformThread::Sleep
// - winbase::Process::WaitForExit
// - winbase::Process::WaitForExitWithTimeout
//
...
class WINBASE_EXPORT TaskTraits {
 private:
 ...
 public:
  ...
  //
  // E.g.
  // constexpr winbase::TaskTraits default_traits = {};
  // constexpr winbase::TaskTraits user_visible_traits =
  //     {winbase::TaskPriority::USER_VISIBLE};
  // constexpr winbase::TaskTraits user_visible_may_block_traits = {
  //     winbase::TaskPriority::USER_VISIBLE, winbase::MayBlock()};
  // constexpr winbase::TaskTraits other_user_visible_may_block_traits = {
  //     winbase::MayBlock(), winbase::TaskPriority::USER_VISIBLE};
...
WINBASE_EXPORT const char* TaskPriorityToString(TaskPriority task_priority);
WINBASE_EXPORT const char* TaskShutdownBehaviorToString(
...
WINBASE_EXPORT std::ostream& operator<<(
    std::ostream& os,
...
#endif  // WINLIB_WINBASE_TASK_SCHEDULER_TASK_TRAITS_H_