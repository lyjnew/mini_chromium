...
#ifndef WINLIB_WINBASE_TASK_SCHEDULER_POST_TASK_H_
#define WINLIB_WINBASE_TASK_SCHEDULER_POST_TASK_H_
...
//     task_runner.PostTask(WINBASE_FROM_HERE, Bind(...));
//     task_runner.PostTask(WINBASE_FROM_HERE, Bind(...));
//
...
WINBASE_EXPORT void PostTask(const Location& from_here, OnceClosure task);
...
WINBASE_EXPORT void PostDelayedTask(const Location& from_here,
                                    OnceClosure task,
                                    TimeDelta delay);
...
WINBASE_EXPORT void PostTaskAndReply(const Location& from_here,
                                     OnceClosure task,
                                     OnceClosure reply);
...
WINBASE_EXPORT void PostTaskWithTraits(const Location& from_here,
...
WINBASE_EXPORT void PostDelayedTaskWithTraits(const Location& from_here,
                                              const TaskTraits& traits,
                                              OnceClosure task,
                                              TimeDelta delay);
...
// SequencedTaskRunnerHandle::IsSet().
WINBASE_EXPORT void PostTaskWithTraitsAndReply(const Location& from_here,
                                               const TaskTraits& traits,
                                               OnceClosure task,
                                               OnceClosure reply);
...
WINBASE_EXPORT scoped_refptr<TaskRunner> CreateTaskRunnerWithTraits(
    const TaskTraits& traits);
...
WINBASE_EXPORT scoped_refptr<SequencedTaskRunner>
...
WINBASE_EXPORT scoped_refptr<SingleThreadTaskRunner>
...
#endif  // WINLIB_WINBASE_TASK_SCHEDULER_POST_TASK_H_