...
#ifndef WINLIB_WINBASE_TASK_SCHEDULER_TASK_SCHEDULER_H_
#define WINLIB_WINBASE_TASK_SCHEDULER_TASK_SCHEDULER_H_
...
// process's instance.
class WINBASE_EXPORT TaskScheduler {
 public:
  struct WINBASE_EXPORT InitParams {
...
#endif  // WINLIB_WINBASE_TASK_SCHEDULER_TASK_SCHEDULER_H_