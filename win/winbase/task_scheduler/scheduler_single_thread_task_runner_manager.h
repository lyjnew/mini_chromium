...
#ifndef WINLIB_WINBASE_TASK_SCHEDULER_SCHEDULER_SINGLE_THREAD_TASK_RUNNER_MANAGER_H_
#define WINLIB_WINBASE_TASK_SCHEDULER_SCHEDULER_SINGLE_THREAD_TASK_RUNNER_MANAGER_H_
...
class WINBASE_EXPORT SchedulerSingleThreadTaskRunnerManager final {
 public:
...
#endif  // WINLIB_WINBASE_TASK_SCHEDULER_SCHEDULER_SINGLE_THREAD_TASK_RUNNER_MANAGER_H_