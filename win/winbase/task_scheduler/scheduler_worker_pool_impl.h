...
#ifndef WINLIB_WINBASE_TASK_SCHEDULER_SCHEDULER_WORKER_POOL_IMPL_H_
#define WINLIB_WINBASE_TASK_SCHEDULER_SCHEDULER_WORKER_POOL_IMPL_H_
...
#include "winbase\task_scheduler\scheduler_worker_pool.h"
...
class WINBASE_EXPORT SchedulerWorkerPoolImpl : public SchedulerWorkerPool {
 public:
  ...
  SchedulerWorkerPoolImpl(const SchedulerWorkerPoolImpl&) = delete;
  SchedulerWorkerPoolImpl& operator=(const SchedulerWorkerPoolImpl&) = delete;
 ...
 private:
  ...
  winbase::stack<TimeTicks, std::vector<TimeTicks>> cleanup_timestamps_;
...
#endif  // WINLIB_WINBASE_TASK_SCHEDULER_SCHEDULER_WORKER_POOL_IMPL_H_