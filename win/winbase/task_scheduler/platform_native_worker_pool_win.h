...
#ifndef WINLIB_WINBASE_TASK_SCHEDULER_PLATFORM_NATIVE_WORKER_POOL_WIN_H_
#define WINLIB_WINBASE_TASK_SCHEDULER_PLATFORM_NATIVE_WORKER_POOL_WIN_H_
...
class WINBASE_EXPORT PlatformNativeWorkerPoolWin : public SchedulerWorkerPool {
 public:
  PlatformNativeWorkerPoolWin(TrackedRef<TaskTracker> task_tracker,
                              DelayedTaskManager* delayed_task_manager);

  PlatformNativeWorkerPoolWin(
      const PlatformNativeWorkerPoolWin&) = delete;
  PlatformNativeWorkerPoolWin& operator=(
      const PlatformNativeWorkerPoolWin&) = delete;
...
#endif  // WINLIB_WINBASE_TASK_SCHEDULER_PLATFORM_NATIVE_WORKER_POOL_WIN_H_