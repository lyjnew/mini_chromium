...
#ifndef WINLIB_WINBASE_TASK_SCHEDULER_TASK_TRAITS_DETAILS_H_
#define WINLIB_WINBASE_TASK_SCHEDULER_TASK_TRAITS_DETAILS_H_
...
#endif  // WINLIB_WINBASE_TASK_SCHEDULER_TASK_TRAITS_DETAILS_H_