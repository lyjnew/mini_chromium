...
#ifndef WINLIB_WINBASE_PICKLE_H_
#define WINLIB_WINBASE_PICKLE_H_
...
class WINBASE_EXPORT PickleIterator {
 public:
...
class WINBASE_EXPORT Pickle {
 public:
  ...
  // attachments.
  class WINBASE_EXPORT Attachment : public RefCountedThreadSafe<Attachment> {
   public:
    Attachment();
  ...
  virtual bool ReadAttachment(winbase::PickleIterator* iter,
  ...
  template <class T>
  T* headerT() {
    WINBASE_DCHECK_EQ(header_size_, sizeof(T));
 ...
 private:
  ...
  void WINBASE_EXPORT WriteBytesStatic(const void* data);
...
#endif  // WINLIB_WINBASE_PICKLE_H_