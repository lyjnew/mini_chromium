...
#ifndef WINLIB_WINBASE_DEBUG_DEBUGGER_H_
#define WINLIB_WINBASE_DEBUG_DEBUGGER_H_
...
WINBASE_EXPORT bool WaitForDebugger(int wait_seconds, bool silent);
...
WINBASE_EXPORT bool BeingDebugged();

// Break into the debugger, assumes a debugger is present.
WINBASE_EXPORT void BreakDebugger();
...
WINBASE_EXPORT void SetSuppressDebugUI(bool suppress);
WINBASE_EXPORT bool IsDebugUISuppressed();

}  // namespace debug
}  // namespace winbase

#endif  // WINLIB_WINBASE_DEBUG_DEBUGGER_H_