...
#ifndef WINLIB_WINBASE_DEBUG_TASK_ANNOTATOR_H_
#define WINLIB_WINBASE_DEBUG_TASK_ANNOTATOR_H_
...
class WINBASE_EXPORT TaskAnnotator {
 public:
...
#endif  // WINLIB_WINBASE_DEBUG_TASK_ANNOTATOR_H_