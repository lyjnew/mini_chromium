...
#ifndef WINLIB_WINBASE_DEBUG_STACK_TRACE_H_
#define WINLIB_WINBASE_DEBUG_STACK_TRACE_H_
...
WINBASE_EXPORT bool EnableInProcessStackDumping();

// A stacktrace can be helpful in debugging. For example, you can include a
// stacktrace member in a object (probably around #ifndef NDEBUG) so that you
// can later see where the given object was created from.
class WINBASE_EXPORT StackTrace {
 public:
...
#endif  // WINLIB_WINBASE_DEBUG_STACK_TRACE_H_