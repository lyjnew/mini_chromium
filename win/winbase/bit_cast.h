...
#ifndef WINLIB_WINBASE_BIT_CAST_H_
#define WINLIB_WINBASE_BIT_CAST_H_
...
inline Dest bit_cast(const Source& source) {
  ...
  static_assert(winbase::is_trivially_copyable<Dest>::value,
                "bit_cast requires the destination type to be copyable");
  static_assert(winbase::is_trivially_copyable<Source>::value,
