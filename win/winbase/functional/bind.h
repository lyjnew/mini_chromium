...
#include "winbase\functional\bind_internal.h"
...
//   winbase::OnceCallback<void(int, long)> cb = winbase::BindOnce(
...
//
//   class C : public winbase::RefCounted<C> { void F(); };
//   auto instance = winbase::MakeRefCounted<C>();
...
// read the top comment of winbase\functional\bind_internal.h for a definition 
...
Bind(Functor&& functor, Args&&... args) {
  return winbase::BindRepeating(std::forward<Functor>(functor),
                                std::forward<Args>(args)...);
}
