...
// static of type winbase::NoDestructor<T> instead:
//
...
//
// Example usage:
//   static LazyInstance<MyClass>::Leaky inst 
...
#ifndef WINLIB_WINBASE_LAZY_INSTANCE_H_
#define WINLIB_WINBASE_LAZY_INSTANCE_H_

#include <new>  // For placement new.

#include "winbase\atomic\atomicops.h"
///#include "winbase\debug\leak_annotations.h"
#include "winbase\lazy_instance_helpers.h"
///#include "winbase\logging.h"
#include "winbase/threading\thread_restrictions.h"

// LazyInstance uses its own struct initializer-list style static
// initialization, which does not require a constructor.
#define WINBASE_LAZY_INSTANCE_INITIALIZER {0}
...
// instead of:
// winbase::LazyInstance<T, winbase::internal::LeakyLazyInstanceTraits<T> >
...
#endif  // WINLIB_WINBASE_LAZY_INSTANCE_H_