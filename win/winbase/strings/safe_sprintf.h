...
#ifndef WINLIB_WINBASE_STRINGS_SAFE_SPRINTF_H_
#define WINLIB_WINBASE_STRINGS_SAFE_SPRINTF_H_
...
// Basic example:
//   char buf[20];
//   winbase::strings::SafeSPrintf(buf, "The answer: %2d", 42);
//
...
WINBASE_EXPORT ssize_t SafeSNPrintf(char* buf, size_t sz, const char* fmt,
...
WINBASE_EXPORT void SetSafeSPrintfSSizeMaxForTest(size_t max);
WINBASE_EXPORT size_t GetSafeSPrintfSSizeMaxForTest();
#endif
...
WINBASE_EXPORT ssize_t SafeSNPrintf(char* buf, size_t N, const char* fmt);
template<size_t N>
...
#endif  // WINLIB_WINBASE_STRINGS_SAFE_SPRINTF_H_