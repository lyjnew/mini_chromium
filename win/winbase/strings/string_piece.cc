...
///  WINBASE_DCHECK(begin <= end) << "StringPiece iterators swapped or invalid.";
///}
///void AssertIteratorsInOrder(string16::const_iterator begin,
///                            string16::const_iterator end) {
///  WINBASE_DCHECK(begin <= end) << "StringPiece16 iterators swapped or invalid.";
///}
///#endif
