...
#ifndef WINLIB_WINBASE_FILES_FILE_PATH_H_
#define WINLIB_WINBASE_FILES_FILE_PATH_H_
...
// in the unit test.
#define WINBASE_FILE_PATH_USES_DRIVE_LETTERS
#define WINBASE_FILE_PATH_USES_WIN_SEPARATORS

// To print path names portably use PRIsFP (based on PRIuS and friends from
// C99 and format_macros.h) like this:
// winbase::StringPrintf("Path is %" PRIsFP ".\n", path.value().c_str());
#define WinBasePRIsFP "ls"
...
#define WINBASE_FILE_PATH_LITERAL(x) L ## x
#define WinBasePRFilePath "ls"

namespace std {

template <>
struct hash<winbase::FilePath> {
  typedef winbase::FilePath argument_type;
  typedef std::size_t result_type;
  result_type operator()(argument_type const& f) const {
    return hash<winbase::FilePath::StringType>()(f.value());
  }
};

}  // namespace std

#endif  // WINLIB_WINBASE_FILES_FILE_PATH_H_