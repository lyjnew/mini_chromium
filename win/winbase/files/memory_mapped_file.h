...
#ifndef WINLIB_WINBASE_FILES_MEMORY_MAPPED_FILE_H_
#define WINLIB_WINBASE_FILES_MEMORY_MAPPED_FILE_H_
...
class WINBASE_EXPORT MemoryMappedFile {
 public:
  enum Access {
...
#endif  // WINLIB_WINBASE_FILES_MEMORY_MAPPED_FILE_H_