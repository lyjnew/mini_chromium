...
#ifndef WINLIB_WINBASE_FILES_FILE_PATH_WATCHER_H_
#define WINLIB_WINBASE_FILES_FILE_PATH_WATCHER_H_
...
class WINBASE_EXPORT FilePathWatcher {
 public:
  ...
  typedef winbase::Callback<void(const FilePath& path, bool error)> Callback;
...
#endif  // WINLIB_WINBASE_FILES_FILE_PATH_WATCHER_H_