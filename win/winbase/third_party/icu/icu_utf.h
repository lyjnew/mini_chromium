...
#ifndef WINLIB_WINBASE_THIRD_PARTY_ICU_ICU_UTF_H_
#define WINLIB_WINBASE_THIRD_PARTY_ICU_ICU_UTF_H_

#include <stdint.h>

namespace winbase_icu {
 ...
 */
UChar32
utf8_nextCharSafeBody(const uint8_t *s, int32_t *pi, int32_t length, ::winbase_icu::UChar32 c, ::winbase_icu::UBool strict);
...
#define CBU8_NEXT(s, i, length, c) { \
    ...
    if(!CBU8_IS_SINGLE(c)) { \
        ...
        if( /* handle U+0800..U+FFFF inline */ \
            ...
            (c)=::winbase_icu::utf8_nextCharSafeBody((const uint8_t *)s, &(i), (length), c, -1); \
        } \
    } \
}
...
#define CBU16_GET_SUPPLEMENTARY(lead, trail) \
    (((::winbase_icu::UChar32)(lead)<<10UL)+(::winbase_icu::UChar32)(trail)-CBU16_SURROGATE_OFFSET)
 ...
 * @stable ICU 2.4
 */
#define CBU16_LEAD(supplementary) (::winbase_icu::UChar)(((supplementary)>>10)+0xd7c0)
 ...
 * @stable ICU 2.4
 */
#define CBU16_TRAIL(supplementary) (::winbase_icu::UChar)(((supplementary)&0x3ff)|0xdc00)
...
}  // namesapce winbase_icu

#endif  // WINLIB_WINBASE_THIRD_PARTY_ICU_ICU_UTF_H_