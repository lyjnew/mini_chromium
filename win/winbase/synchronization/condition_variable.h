...
#ifndef WINLIB_WINBASE_SYNCHRONIZATION_CONDITION_VARIABLE_H_
#define WINLIB_WINBASE_SYNCHRONIZATION_CONDITION_VARIABLE_H_
...
class WINBASE_EXPORT ConditionVariable {
 public:
...
#endif  // WINLIB_WINBASE_SYNCHRONIZATION_CONDITION_VARIABLE_H_