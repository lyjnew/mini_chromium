...
#ifndef WINLIB_WINBASE_LAZY_INSTANCE_INTERNAL_H_
#define WINLIB_WINBASE_LAZY_INSTANCE_INTERNAL_H_
...
WINBASE_EXPORT bool NeedsLazyInstance(subtle::AtomicWord* state);
...
WINBASE_EXPORT void CompleteLazyInstance(subtle::AtomicWord* state,
...
Type* GetOrCreateLazyPointer(subtle::AtomicWord* state,
                             ...
                             void (*destructor)(void*),
                             void* destructor_arg) {
  WINBASE_DCHECK(state);
  WINBASE_DCHECK(creator_func);
  ...
  if (!(instance & kLazyInstanceCreatedMask)) {
    if (internal::NeedsLazyInstance(state)) {
      ...
      WINBASE_DCHECK(instance & kLazyInstanceCreatedMask);
    }
  }
...
#endif  // WINLIB_WINBASE_LAZY_INSTANCE_INTERNAL_H_