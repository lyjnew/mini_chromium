...
#ifndef WINLIB_WINBASE_MEMORY_SINGLETON_H_
#define WINLIB_WINBASE_MEMORY_SINGLETON_H_
...
//    private:
//     FooClass() { ... }
//     friend struct winbase::DefaultSingletonTraits<FooClass>;
//   };
//
// In your source file:
//  #include "winbase\memory\singleton.h"
//  FooClass* FooClass::GetInstance() {
//    return winbase::Singleton<FooClass>::get();
//  }
//
// Or for leaky singletons:
//  #include "winbase\memory\singleton.h"
//  FooClass* FooClass::GetInstance() {
//    return winbase::Singleton<
//        FooClass, winbase::LeakySingletonTraits<FooClass>>::get();
//  }
//
...
#endif  // WINLIB_WINBASE_MEMORY_SINGLETON_H_