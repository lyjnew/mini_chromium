...
#ifndef WINLIB_WINBASE_STL_UTIL_H_
#define WINLIB_WINBASE_STL_UTIL_H_
...
ResultType STLSetDifference(const Arg1& a1, const Arg2& a2) {
  WINBASE_DCHECK(STLIsSorted(a1));
  WINBASE_DCHECK(STLIsSorted(a2));
...
template <class T>
T* OptionalOrNullptr(winbase::Optional<T>& optional) {
  return optional.has_value() ? &optional.value() : nullptr;
}

template <class T>
const T* OptionalOrNullptr(const winbase::Optional<T>& optional) {
  return optional.has_value() ? &optional.value() : nullptr;
}

}  // namespace winbase

#endif  // WINLIB_WINBASE_STL_UTIL_H_