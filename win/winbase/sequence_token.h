...
#ifndef WINLIB_WINBASE_SEQUENCE_TOKEN_H_
#define WINLIB_WINBASE_SEQUENCE_TOKEN_H_
...
class WINBASE_EXPORT SequenceToken {
 public:
...
class WINBASE_EXPORT TaskToken {
 public:
...
class WINBASE_EXPORT ScopedSetSequenceTokenForCurrentThread {
 public:
...
#endif  // WINLIB_WINBASE_SEQUENCE_TOKEN_H_