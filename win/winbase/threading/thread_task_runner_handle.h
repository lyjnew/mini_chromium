...
#ifndef WINLIBV_WINBASE_THREADING_THREAD_TASK_RUNNER_HANDLE_H_
#define WINLIBV_WINBASE_THREADING_THREAD_TASK_RUNNER_HANDLE_H_
...
class WINBASE_EXPORT ThreadTaskRunnerHandle {
 public:
...
#endif  // WINLIB_WINBASE_THREADING_THREAD_TASK_RUNNER_HANDLE_H_