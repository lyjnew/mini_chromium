...
#ifndef WINLIB_WINBASE_THREADING_SCOPED_BLOCKING_CALL_H
#define WINLIB_WINBASE_THREADING_SCOPED_BLOCKING_CALL_H
...
class WINBASE_EXPORT ScopedBlockingCall {
 public:
...
class WINBASE_EXPORT BlockingObserver {
 public:
...
WINBASE_EXPORT void SetBlockingObserverForCurrentThread(
    BlockingObserver* blocking_observer);

///WINBASE_EXPORT void ClearBlockingObserverForTesting();
///
...
///class WINBASE_EXPORT ScopedClearBlockingObserverForTesting {
/// public:
///  ScopedClearBlockingObserverForTesting();
///  ScopedClearBlockingObserverForTesting(
///      const ScopedClearBlockingObserverForTesting&) = delete;
///  ScopedClearBlockingObserverForTesting& operator=(
///      const ScopedClearBlockingObserverForTesting&) = delete;
///  ~ScopedClearBlockingObserverForTesting();
///
/// private:
...
#endif  // WINLIB_WINBASE_THREADING_SCOPED_BLOCKING_CALL_H