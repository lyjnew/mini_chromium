...
#ifndef WINLIB_WINBASE_THREADING_SIMPLE_THREAD_H_
#define WINLIB_WINBASE_THREADING_SIMPLE_THREAD_H_
...
class WINBASE_EXPORT SimpleThread : public PlatformThread::Delegate {
 public:
  struct WINBASE_EXPORT Options {
   public:
    Options() = default;
...
class WINBASE_EXPORT DelegateSimpleThread : public SimpleThread {
 public:
...
class WINBASE_EXPORT DelegateSimpleThreadPool
 ...
 public:
  ...
  DelegateSimpleThreadPool& operator=(const DelegateSimpleThreadPool&) 
      = delete;
 ...
 private:
  ...
  winbase::queue<Delegate*> delegates_;
  winbase::Lock lock_;            // Locks delegates_
  WaitableEvent dry_;    // Not signaled when there is no work to do.
};

}  // namespace winbase

#endif  // WINLIB_WINBASE_THREADING_SIMPLE_THREAD_H_