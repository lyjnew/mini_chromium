...
#ifndef WINLIB_WINBASE_THREADING_THREAD_H_
#define WINLIB_WINBASE_THREADING_THREAD_H_
...
// IMPORTANT: Instead of creating a winbase::Thread, consider using
// winbase::Create(Sequenced|SingleThread)TaskRunnerWithTraits().
//
...
class WINBASE_EXPORT Thread : PlatformThread::Delegate {
 public:
 ...
 private:
  ...
  bool running_ = false;
  mutable winbase::Lock running_lock_;  // Protects |running_|.

  // The thread's handle.
  PlatformThreadHandle thread_;
  mutable winbase::Lock thread_lock_;  // Protects |thread_|.
...
#endif  // WINLIB_WINBASE_THREADING_THREAD_H_