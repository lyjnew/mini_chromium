...
// MD5Update().
WINBASE_EXPORT void MD5Init(MD5Context* context);
...
WINBASE_EXPORT void MD5Update(MD5Context* context, const StringPiece& data);

// Finalizes the MD5 operation and fills the buffer with the digest.
WINBASE_EXPORT void MD5Final(MD5Digest* digest, MD5Context* context);
...
WINBASE_EXPORT void MD5IntermediateFinal(MD5Digest* digest,
                                         const MD5Context* context);

// Converts a digest into human-readable hexadecimal.
WINBASE_EXPORT std::string MD5DigestToBase16(const MD5Digest& digest);

// Computes the MD5 sum of the given data buffer with the given length.
// The given 'digest' structure will be filled with the result data.
WINBASE_EXPORT void MD5Sum(const void* data, size_t length, MD5Digest* digest);
