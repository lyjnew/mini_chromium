...
#ifndef WINLIB_WINBASE_VERSION_H_
#define WINLIB_WINBASE_VERSION_H_
...
WINBASE_EXPORT bool operator==(const Version& v1, const Version& v2);
WINBASE_EXPORT bool operator!=(const Version& v1, const Version& v2);
WINBASE_EXPORT bool operator<(const Version& v1, const Version& v2);
WINBASE_EXPORT bool operator<=(const Version& v1, const Version& v2);
WINBASE_EXPORT bool operator>(const Version& v1, const Version& v2);
WINBASE_EXPORT bool operator>=(const Version& v1, const Version& v2);
WINBASE_EXPORT std::ostream& operator<<(std::ostream& stream, const Version& v);

}  // namespace winbase

#endif  // WINLIB_WINBASE_VERSION_H_