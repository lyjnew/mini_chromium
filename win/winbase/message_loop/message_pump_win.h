...
#ifndef WINLIB_WINBASE_MESSAGE_LOOP_MESSAGE_PUMP_WIN_H_
#define WINLIB_WINBASE_MESSAGE_LOOP_MESSAGE_PUMP_WIN_H_
...
class WINBASE_EXPORT MessagePumpWin : public MessagePump {
 public:
  MessagePumpWin();
...
//
class WINBASE_EXPORT MessagePumpForUI : public MessagePumpWin {
 public:
  MessagePumpForUI();
 ...
 private:
  ...
  winbase::win::MessageWindow message_window_;
...
//
class WINBASE_EXPORT MessagePumpForIO : public MessagePumpWin {
 public:
  struct WINBASE_EXPORT IOContext {
    IOContext();
...
#endif  // WINLIB_WINBASE_MESSAGE_LOOP_MESSAGE_PUMP_WIN_H_