...
#ifndef WINLIB_WINBASE_TIME_TIME_H_
#define WINLIB_WINBASE_TIME_TIME_H_
...
WINBASE_EXPORT int64_t SaturatedAdd(TimeDelta delta, int64_t value);
WINBASE_EXPORT int64_t SaturatedSub(TimeDelta delta, int64_t value);

}  // namespace time_internal

// TimeDelta ------------------------------------------------------------------

class WINBASE_EXPORT TimeDelta {
 public:
...
WINBASE_EXPORT std::ostream& operator<<(std::ostream& os, TimeDelta time_delta);
...
class WINBASE_EXPORT Time : public time_internal::TimeBase<Time> {
 public:
...
// limit year.
  ...
  struct WINBASE_EXPORT Exploded {
...
// For logging use only.
WINBASE_EXPORT std::ostream& operator<<(std::ostream& os, Time time);

// TimeTicks ------------------------------------------------------------------

// Represents monotonically non-decreasing clock time.
class WINBASE_EXPORT TimeTicks : public time_internal::TimeBase<TimeTicks> {
 public:
...
// For logging use only.
WINBASE_EXPORT std::ostream& operator<<(std::ostream& os, TimeTicks time_ticks);

// ThreadTicks ----------------------------------------------------------------

// Represents a clock, specific to a particular thread, than runs only while the
// thread is running.
class WINBASE_EXPORT ThreadTicks : public time_internal::TimeBase<ThreadTicks> {
 public:
...
// For logging use only.
WINBASE_EXPORT std::ostream& operator<<(std::ostream& os, 
                                        ThreadTicks time_ticks);

}  // namespace winbase

#endif  // WINLIB_WINBASE_TIME_TIME_H_