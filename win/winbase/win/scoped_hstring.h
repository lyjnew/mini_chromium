...
#ifndef WINLIB_WINBASE_WIN_SCOPED_HSTRING_H_
#define WINLIB_WINBASE_WIN_SCOPED_HSTRING_H_
...
// WindowsCreateString().
struct WINBASE_EXPORT ScopedHStringTraits {
...
//
class WINBASE_EXPORT ScopedHString
    : public ScopedGeneric<HSTRING, winbase::internal::ScopedHStringTraits> {
 public:
...
#endif  // WINLIB_WINBASE_WIN_SCOPED_HSTRING_H_