...
#ifndef WINLIB_WINBASE_WIN_WRAPPED_WINDOW_PROC_H_
#define WINLIB_WINBASE_WIN_WRAPPED_WINDOW_PROC_H_
...
WINBASE_EXPORT WinProcExceptionFilter SetWinProcExceptionFilter(
    WinProcExceptionFilter filter);

// Calls the registered exception filter.
WINBASE_EXPORT int CallExceptionFilter(EXCEPTION_POINTERS* info);
...
WINBASE_EXPORT void InitializeWindowClass(
...
#endif  // WINLIB_WINBASE_WIN_WRAPPED_WINDOW_PROC_H_