...
#ifndef WINLIB_WINBASE_WIN_STARTUP_INFORMATION_H_
#define WINLIB_WINBASE_WIN_STARTUP_INFORMATION_H_
...
class WINBASE_EXPORT StartupInformation {
 public:
  StartupInformation();
...
#endif  // WINLIB_WINBASE_WIN_STARTUP_INFORMATION_H_