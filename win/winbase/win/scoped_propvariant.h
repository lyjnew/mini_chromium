...
#ifndef WINLIB_WINBASE_WIN_SCOPED_PROPVARIANT_H_
#define WINLIB_WINBASE_WIN_SCOPED_PROPVARIANT_H_
...
class ScopedPropVariant {
 public:
  ...
  // a function call.
  PROPVARIANT* Receive() {
    WINBASE_DCHECK_EQ(pv_.vt, VT_EMPTY);
    return &pv_;
  }
...
#endif  // WINLIB_WINBASE_WIN_SCOPED_PROPVARIANT_H_