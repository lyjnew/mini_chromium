...
#ifndef WINLIB_WINBASE_WIN_SCOPED_WINRT_INITIALIZER_H_
#define WINLIB_WINBASE_WIN_SCOPED_WINRT_INITIALIZER_H_
...
class WINBASE_EXPORT ScopedWinrtInitializer
...
#endif  // WINLIB_WINBASE_WIN_SCOPED_WINRT_INITIALIZER_H_