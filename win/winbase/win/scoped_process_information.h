...
#ifndef WINLIB_WINBASE_WIN_SCOPED_PROCESS_INFORMATION_H_
#define WINLIB_WINBASE_WIN_SCOPED_PROCESS_INFORMATION_H_
...
class WINBASE_EXPORT ScopedProcessInformation {
 public:
...
#endif  // WINLIB_WINBASE_WIN_SCOPED_PROCESS_INFORMATION_H_