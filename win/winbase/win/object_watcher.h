...
#ifndef WINLIB_WINBASE_WIN_OBJECT_WATCHER_H_
#define WINLIB_WINBASE_WIN_OBJECT_WATCHER_H_
...
class WINBASE_EXPORT ObjectWatcher {
 public:
...
#endif  // WINLIB_WINBASE_WIN_OBJECT_WATCHER_H_