...
#ifndef WINLIB_WINBASE_WIN_SCOPED_HANDLE_H_
#define WINLIB_WINBASE_WIN_SCOPED_HANDLE_H_
...
#include <intrin.h>
#define WINBASE_WIN_GET_CALLER _ReturnAddress()
#elif defined(COMPILER_GCC)
#define WINBASE_WIN_GET_CALLERWINBASE_WIN_GET_CALLER \
...
class HandleTraits {
 public:
  ...
  // Closes the handle.
  static bool WINBASE_EXPORT CloseHandle(HANDLE handle);
...
class WINBASE_EXPORT VerifierTraits {
 public:
  typedef HANDLE Handle;
...
// for ScopedHandle.
WINBASE_EXPORT void DisableHandleVerifier();

// This should be called whenever the OS is closing a handle, if extended
// verification of improper handle closing is desired. If |handle| is being
// tracked by the handle verifier and ScopedHandle is not the one closing it,
// a CHECK is generated.
WINBASE_EXPORT void OnHandleBeingClosed(HANDLE handle);
}  // namespace win
}  // namespace winbase

#endif  // WINLIB_WINBASE_WIN_SCOPED_HANDLE_H_