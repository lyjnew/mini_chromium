...
#ifndef WINLIB_WINBASE_VALUES_H_
#define WINLIB_WINBASE_VALUES_H_
...
//
// winbase::Value is currently in the process of being refactored. Design doc:
...
// used derived types to implement the individual data types, and winbase::Value
// was just a base class to refer to them. This required everything be heap
// allocated.
//
// OLD WAY:
//
//   std::unique_ptr<winbase::Value> GetFoo() {
//     std::unique_ptr<DictionaryValue> dict;
//     dict->SetString("mykey", foo);
//     return dict;
//   }
//
// The new design makes winbase::Value a variant type that holds everything in
...
// NEW WAY:
//
//   winbase::Value GetFoo() {
//     winbase::Value dict(winbase::Value::Type::DICTIONARY);
//     dict.SetKey("mykey", winbase::Value(foo));
//     return dict;
//   }
class WINBASE_EXPORT Value {
 public:
  ...
  WINBASE_EXPORT friend bool operator==(const Value& lhs, const Value& rhs);
  WINBASE_EXPORT friend bool operator!=(const Value& lhs, const Value& rhs);
  WINBASE_EXPORT friend bool operator<(const Value& lhs, const Value& rhs);
  WINBASE_EXPORT friend bool operator>(const Value& lhs, const Value& rhs);
  WINBASE_EXPORT friend bool operator<=(const Value& lhs, const Value& rhs);
...
class WINBASE_EXPORT DictionaryValue : public Value {
 public:
...
class WINBASE_EXPORT ListValue : public Value {
 public:
...
// Value objects.
class WINBASE_EXPORT ValueSerializer {
 public:
...
// objects.
class WINBASE_EXPORT ValueDeserializer {
 public:
...
WINBASE_EXPORT std::ostream& operator<<(std::ostream& out, const Value& value);

WINBASE_EXPORT inline std::ostream& operator<<(std::ostream& out,
...
#endif  // WINLIB_WINBASE_VALUES_H_