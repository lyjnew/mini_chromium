...
#ifndef WINLIB_WINBASE_CONTAINERS_FLAT_TREE_H_
#define WINLIB_WINBASE_CONTAINERS_FLAT_TREE_H_
...
template <class Key,
          ...
          typename Predicate>
void EraseIf(
    winbase::internal::flat_tree<Key, Value, GetKeyFromValue, KeyCompare>&
        container,
    Predicate pred) {
...
#endif  // WINLIB_WINBASE_CONTAINERS_FLAT_TREE_H_