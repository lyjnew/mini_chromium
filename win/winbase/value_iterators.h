...
#ifndef WINLIB_WINBASE_VALUE_ITERATORS_H_
#define WINLIB_WINBASE_VALUE_ITERATORS_H_
...
using DictStorage = winbase::flat_map<std::string, std::unique_ptr<Value>>;
...
class WINBASE_EXPORT dict_iterator {
 public:
  ...
  WINBASE_EXPORT friend bool operator==(const dict_iterator& lhs,
...
// access without incurring a copy.
class WINBASE_EXPORT const_dict_iterator {
 public:
  ...
  WINBASE_EXPORT friend bool operator==(const const_dict_iterator& lhs,
...
// const-qualification.
class WINBASE_EXPORT dict_iterator_proxy {
 public:
...
class WINBASE_EXPORT const_dict_iterator_proxy {
 public:
...
#endif  // WINLIB_WINBASE_VALUE_ITERATORS_H_