...
#ifndef WINLIB_WINBASE_SEQUENCED_TASK_RUNNER_HELPERS_H_
#define WINLIB_WINBASE_SEQUENCED_TASK_RUNNER_HELPERS_H_
...
#endif  // WINLIB_WINBASE_SEQUENCED_TASK_RUNNER_HELPERS_H_