...
#ifndef MINI_CHROMIUM_CRBASE_FILES_FILE_PATH_H_
#define MINI_CHROMIUM_CRBASE_FILES_FILE_PATH_H_
...
// in the unit test.
#define CR_FILE_PATH_USES_DRIVE_LETTERS
#define CR_FILE_PATH_USES_WIN_SEPARATORS
...
class CRBASE_EXPORT FilePath {
 public:
  ...
  FilePath ReplaceExtension(StringPieceType extension) 
      const CR_WARN_UNUSED_RESULT;
...
#define CR_FILE_PATH_LITERAL(x) L ## x
#define CR_PRFilePath "ls"
...
#endif  // MINI_CHROMIUM_CRBASE_FILES_FILE_PATH_H_