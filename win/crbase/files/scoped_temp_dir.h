...
#ifndef MINI_CHROMIUM_CRBASE_FILES_SCOPED_TEMP_DIR_H_
#define MINI_CHROMIUM_CRBASE_FILES_SCOPED_TEMP_DIR_H_
...
class CRBASE_EXPORT ScopedTempDir {
 public:
  ...
  bool CreateUniqueTempDir() CR_WARN_UNUSED_RESULT;
  ...
  bool Set(const FilePath& path) CR_WARN_UNUSED_RESULT;

  // Deletes the temporary directory wrapped by this object.
  bool Delete() CR_WARN_UNUSED_RESULT;
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(ScopedTempDir);
};

}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_FILES_SCOPED_TEMP_DIR_H_