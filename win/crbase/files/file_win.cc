...
///#include "crbase/metrics/sparse_histogram.h"
...
int64_t File::Seek(Whence whence, int64_t offset) {
  ...
  CR_SCOPED_FILE_TRACE_WITH_SIZE("Seek", offset);
...
int File::Read(int64_t offset, char* data, int size) {
  ...
  CR_SCOPED_FILE_TRACE_WITH_SIZE("Read", size);
...
int File::ReadAtCurrentPos(char* data, int size) {
  ...
  CR_SCOPED_FILE_TRACE_WITH_SIZE("ReadAtCurrentPos", size);
...
int File::Write(int64_t offset, const char* data, int size) {
  ...
  CR_SCOPED_FILE_TRACE_WITH_SIZE("Write", size);
...
int File::WriteAtCurrentPos(const char* data, int size) {
  ...
  CR_SCOPED_FILE_TRACE_WITH_SIZE("WriteAtCurrentPos", size);
...
int64_t File::GetLength() {
  ...
  CR_SCOPED_FILE_TRACE("GetLength");
...
bool File::SetLength(int64_t length) {
  ...
  CR_SCOPED_FILE_TRACE_WITH_SIZE("SetLength", length);
...
File File::Duplicate() {
  ...
  CR_SCOPED_FILE_TRACE("Duplicate");
