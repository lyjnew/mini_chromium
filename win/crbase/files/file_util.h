...
#ifndef MINI_CHROMIUM_CRBASE_FILES_FILE_UTIL_H_
#define MINI_CHROMIUM_CRBASE_FILES_FILE_UTIL_H_
...
CRBASE_EXPORT int GetMaximumPathComponentLength(const crbase::FilePath& path);
...
#endif  // MINI_CHROMIUM_CRBASE_FILES_FILE_UTIL_H_