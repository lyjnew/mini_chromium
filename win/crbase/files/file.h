...
#ifndef MINI_CHROMIUM_CRBASE_FILES_FILE_H_
#define MINI_CHROMIUM_CRBASE_FILES_FILE_H_
...
// member variables.
class CRBASE_EXPORT File {
  CR_MOVE_ONLY_TYPE_FOR_CPP_03(File)
...
#endif  // MINI_CHROMIUM_CRBASE_FILES_FILE_H_