...
#ifndef MINI_CHROMIUM_CRBASE_FILES_FILE_ENUMERATOR_H_
#define MINI_CHROMIUM_CRBASE_FILES_FILE_ENUMERATOR_H_
...
class CRBASE_EXPORT FileEnumerator {
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(FileEnumerator);
};

}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_FILES_FILE_ENUMERATOR_H_