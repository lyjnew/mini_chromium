...
#ifndef MINI_CHROMIUM_CRBASE_NUMERICS_SAFE_CONVERSIONS_IMPL_H_
#define MINI_CHROMIUM_CRBASE_NUMERICS_SAFE_CONVERSIONS_IMPL_H_
...
inline RangeConstraint GetRangeConstraint(int integer_range_constraint) {
  CR_DCHECK(integer_range_constraint >= RANGE_VALID &&
...
#endif  // MINI_CHROMIUM_CRBASE_NUMERICS_SAFE_CONVERSIONS_IMPL_H_