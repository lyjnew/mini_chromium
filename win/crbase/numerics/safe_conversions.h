...
#ifndef MINI_CHROMIUM_CRBASE_NUMERICS_SAFE_CONVERSIONS_H_
#define MINI_CHROMIUM_CRBASE_NUMERICS_SAFE_CONVERSIONS_H_
...
#endif  // MINI_CHROMIUM_CRBASE_NUMERICS_SAFE_CONVERSIONS_H_