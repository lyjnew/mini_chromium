...
#ifndef MINI_CHROMIUM_CRBASE_NUMERICS_SAFE_MATH_IMPL_H_
#define MINI_CHROMIUM_CRBASE_NUMERICS_SAFE_MATH_IMPL_H_
...
#endif  // MINI_CHROMIUM_CRBASE_NUMERICS_SAFE_MATH_IMPL_H_