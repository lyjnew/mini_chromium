...
#ifndef MINI_CHROMIUM_CRBASE_SYNCHRONIZATION_WAITABLE_EVENT_H_
#define MINI_CHROMIUM_CRBASE_SYNCHRONIZATION_WAITABLE_EVENT_H_
...
class CRBASE_EXPORT WaitableEvent {
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(WaitableEvent);
};

}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_SYNCHRONIZATION_WAITABLE_EVENT_H_