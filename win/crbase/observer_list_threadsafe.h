...
#ifndef MINI_CHROMIUM_CRBASE_OBSERVER_LIST_THREADSAFE_H_
#define MINI_CHROMIUM_CRBASE_OBSERVER_LIST_THREADSAFE_H_
...
class ObserverListThreadSafe
 ...
 public:
  ...
  void AssertEmpty() const {
    AutoLock lock(list_lock_);
    CR_DCHECK(observer_lists_.empty());
  }
 ...
 private:
  ...
  struct ObserverListContext {
   ...
   private:
    CR_DISALLOW_COPY_AND_ASSIGN(ObserverListContext);
  };

  ~ObserverListThreadSafe() {
    crbase::STLDeleteValues(&observer_lists_);
  }
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(ObserverListThreadSafe);
};

}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_OBSERVER_LIST_THREADSAFE_H_