...
#ifndef MINI_CHROMIUM_CRBASE_TIME_DEFAULT_TICK_CLOCK_H_
#define MINI_CHROMIUM_CRBASE_TIME_DEFAULT_TICK_CLOCK_H_
...
#endif  // MINI_CHROMIUM_CRBASE_TIME_DEFAULT_TICK_CLOCK_H_