...
#ifndef MINI_CHROMIUM_CRBASE_DEBUG_TASK_ANNOTATOR_H_
#define MINI_CHROMIUM_CRBASE_DEBUG_TASK_ANNOTATOR_H_
...
class CRBASE_EXPORT TaskAnnotator {
 public:
  TaskAnnotator();
  ~TaskAnnotator();
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(TaskAnnotator);
};
...
#endif  // MINI_CHROMIUM_CRBASE_DEBUG_TASK_ANNOTATOR_H_