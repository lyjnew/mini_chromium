...
#ifndef MINI_CHROMIUM_CRBASE_SCOPED_OBSERVER_H_
#define MINI_CHROMIUM_CRBASE_SCOPED_OBSERVER_H_
...
class ScopedObserver {
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(ScopedObserver);
};

}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_SCOPED_OBSERVER_H_