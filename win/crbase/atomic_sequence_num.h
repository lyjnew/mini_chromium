...
#ifndef MINI_CHROMIUM_CRBASE_ATOMIC_SEQUENCE_NUM_H_
#define MINI_CHROMIUM_CRBASE_ATOMIC_SEQUENCE_NUM_H_
...
class AtomicSequenceNumber {
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(AtomicSequenceNumber);
};

}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_ATOMIC_SEQUENCE_NUM_H_