...
#ifndef MINI_CHROMIUM_CRBASE_SCOPED_GENERIC_H_
#define MINI_CHROMIUM_CRBASE_SCOPED_GENERIC_H_
...
class ScopedGeneric {
  CR_DISALLOW_COPY_AND_ASSIGN_WITH_MOVE_FOR_BIND(ScopedGeneric)
