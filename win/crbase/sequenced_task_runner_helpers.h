...
#ifndef MINI_CHROMIUM_CRBASE_SEQUENCED_TASK_RUNNER_HELPERS_H_
#define MINI_CHROMIUM_CRBASE_SEQUENCED_TASK_RUNNER_HELPERS_H_
...
class DeleteHelper {
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(DeleteHelper);
};
...
class ReleaseHelper {
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(ReleaseHelper);
};
...
// signature:
//
// bool(const crtracked_objects::Location&,
...
class DeleteHelperInternal {
 ...
 private:
  CR_DISALLOW_COPY_AND_ASSIGN(DeleteHelperInternal);
};
...
class ReleaseHelperInternal {
 ...
 private:
  CR_DISALLOW_COPY_AND_ASSIGN(ReleaseHelperInternal);
};
