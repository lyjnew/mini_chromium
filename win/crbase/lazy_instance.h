...
// a global variable using the CR_LAZY_INSTANCE_INITIALIZER initializer.
//
...
//
// Example usage:
//   static LazyInstance<MyClass> my_instance = CR_LAZY_INSTANCE_INITIALIZER;
//   void SomeMethod() {
...
struct DefaultLazyInstanceTraits {
  ...
  static Type* New(void* instance) {
    CR_DCHECK_EQ(reinterpret_cast<uintptr_t>(instance) & (CR_ALIGNOF(Type) - 1),
                 0u)
...
// crbase::LazyInstance<T>::Leaky my_leaky_lazy_instance;
// instead of:
// crbase::LazyInstance<T, crbase::internal::LeakyLazyInstanceTraits<T> >
