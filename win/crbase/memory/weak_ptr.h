...
class CRBASE_EXPORT WeakReferenceOwner {
 public:
  WeakReferenceOwner();
  ~WeakReferenceOwner();
...
class CRBASE_EXPORT WeakPtrBase {
 public:
  WeakPtrBase();
  ~WeakPtrBase();
...
class WeakPtrFactory {
 ...
 private:
  ...
  T* ptr_;
  CR_DISALLOW_IMPLICIT_CONSTRUCTORS(WeakPtrFactory);
};
...
class SupportsWeakPtr : public internal::SupportsWeakPtrBase {
 ...
 private:
  internal::WeakReferenceOwner weak_reference_owner_;
  CR_DISALLOW_COPY_AND_ASSIGN(SupportsWeakPtr);
};
...
// the caller.
//
//   crbase::WeakPtr<Derived> ptr = derived.AsWeakPtr();  // Fails.
