...
#ifndef MINI_CHROMIUM_CRBASE_MEMORY_LINKED_PTR_H_
#define MINI_CHROMIUM_CRBASE_MEMORY_LINKED_PTR_H_

#include "crbase/logging.h"  // for CR_CHECK macros
...
#endif  // MINI_CHROMIUM_CRBASE_MEMORY_LINKED_PTR_H_