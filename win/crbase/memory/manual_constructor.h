...
#ifndef MINI_CHROMIUM_CRBASE_MEMORY_MANUAL_CONSTRUCTOR_H_
#define MINI_CHROMIUM_CRBASE_MEMORY_MANUAL_CONSTRUCTOR_H_
...
class ManualConstructor {
 public:
  ...
  static void* operator new[](size_t size) {
    return AlignedAlloc(size, CR_ALIGNOF(Type));
  }
...
#endif  // MINI_CHROMIUM_CRBASE_MEMORY_MANUAL_CONSTRUCTOR_H_