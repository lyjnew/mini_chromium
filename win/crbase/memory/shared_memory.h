...
#ifndef MINI_CHROMIUM_CRBASE_MEMORY_SHARED_MEMORY_H_
#define MINI_CHROMIUM_CRBASE_MEMORY_SHARED_MEMORY_H_
...
struct CRBASE_EXPORT SharedMemoryCreateOptions {
...
class CRBASE_EXPORT SharedMemory {
 public:
  SharedMemory();
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(SharedMemory);
};
}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_MEMORY_SHARED_MEMORY_H_