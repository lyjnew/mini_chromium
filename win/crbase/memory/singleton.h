...
#ifndef MINI_CHROMIUM_CRBASE_MEMORY_SINGLETON_H_
#define MINI_CHROMIUM_CRBASE_MEMORY_SINGLETON_H_
...
CRBASE_EXPORT subtle::AtomicWord WaitForInstance(subtle::AtomicWord* instance);
...
struct StaticMemorySingletonTraits {
 ...
 private:
  static AlignedMemory<sizeof(Type), CR_ALIGNOF(Type)> buffer_;
  // Signal the object was already deleted, so it is not revived.
  static subtle::Atomic32 dead_;
};

template <typename Type>
AlignedMemory<sizeof(Type), CR_ALIGNOF(Type)>
...
//
//     CR_DISALLOW_COPY_AND_ASSIGN(FooClass);
//   };
//
// In your source file:
...
#endif  // MINI_CHROMIUM_CRBASE_MEMORY_SINGLETON_H_