...
#ifndef MINI_CHROMIUM_CRBASE_MEMORY_SHARED_MEMORY_HANDLE_H_
#define MINI_CHROMIUM_CRBASE_MEMORY_SHARED_MEMORY_HANDLE_H_
...
class CRBASE_EXPORT SharedMemoryHandle {
 public:
  ...
  SharedMemoryHandle();
  SharedMemoryHandle(HANDLE h, crbase::ProcessId pid);
 ...
 private:
  ...
  crbase::ProcessId pid_;
};

}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_MEMORY_SHARED_MEMORY_HANDLE_H_