...
#ifndef MINI_CHROMIUM_CRBASE_OBSERVER_LIST_H_
#define MINI_CHROMIUM_CRBASE_OBSERVER_LIST_H_
...
class ObserverListBase
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(ObserverListBase);
};
 ...
 public:
  ...
  ~ObserverList() {
    ...
    if (check_empty) {
      ...
      CR_DCHECK_EQ(ObserverListBase<ObserverType>::size(), 0U);
    }
  }
...
#endif  // MINI_CHROMIUM_CRBASE_OBSERVER_LIST_H_