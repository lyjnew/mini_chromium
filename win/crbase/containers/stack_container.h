...
#ifndef MINI_CHROMIUM_CRBASE_CONTAINERS_STACK_CONTAINER_H_
#define MINI_CHROMIUM_CRBASE_CONTAINERS_STACK_CONTAINER_H_
...
#if defined(__GNUC__) && !defined(MINI_CHROMIUM_ARCH_CPU_X86_FAMILY)
    static_assert(CR_ALIGNOF(T) <= 16, "http://crbug.com/115612");
#endif
...
class StackContainer {
 ...
 private:
  CR_DISALLOW_COPY_AND_ASSIGN(StackContainer);
};
...
class StackString : public StackContainer<
 ...
 private:
  CR_DISALLOW_COPY_AND_ASSIGN(StackString);
};
...
class StackString16 : public StackContainer<
 ...
 private:
  CR_DISALLOW_COPY_AND_ASSIGN(StackString16);
};
...
#endif  // MINI_CHROMIUM_CRBASE_CONTAINERS_STACK_CONTAINER_H_