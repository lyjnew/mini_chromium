...
#ifndef MINI_CHROMIUM_CRBASE_CONTAINERS_HASH_TABLES_H_
#define MINI_CHROMIUM_CRBASE_CONTAINERS_HASH_TABLES_H_
...
#define CRBASE_HASH_NAMESPACE std

#elif defined(MINI_CHROMIUM_COMPILER_GCC)

#define CRBASE_HASH_NAMESPACE crbase_hash
...
#define CRBASE_HASH_IMPL_NAMESPACE __gnu_cxx
...
namespace CRBASE_HASH_NAMESPACE {
...
struct hash {
  std::size_t operator()(const T& value) const {
    return CRBASE_HASH_IMPL_NAMESPACE::hash<T>()(value);
  }
};
...
struct hash<T*> {
  std::size_t operator()(T* value) const {
    return CRBASE_HASH_IMPL_NAMESPACE::hash<uintptr_t>()(
...
DEFINE_STRING_HASH(crbase::string16);
...
#else  // COMPILER
#error define CRBASE_HASH_NAMESPACE for your compiler
#endif  // COMPILER
...
#else  // !MINI_CHROMIUM_COMPILER_MSVC
...
template<class Key, class T,
         ...
         class Alloc = std::allocator<std::pair<const Key, T>>>
using hash_multimap =
    CRBASE_HASH_IMPL_NAMESPACE::hash_multimap<Key, T, Hash, Pred, Alloc>;
...
template<class Key,
         ...
         class Alloc = std::allocator<Key>>
using hash_multiset =
    CRBASE_HASH_IMPL_NAMESPACE::hash_multiset<Key, Hash, Pred, Alloc>;

template<class Key,
         class Hash = BASE_HASH_NAMESPACE::hash<Key>,
         class Pred = std::equal_to<Key>,
         class Alloc = std::allocator<Key>>
using hash_set = CRBASE_HASH_IMPL_NAMESPACE::hash_set<Key, Hash, Pred, Alloc>;

#undef CRBASE_HASH_IMPL_NAMESPACE
...
#endif  // CRBASE_CONTAINERS_HASH_TABLES_H_