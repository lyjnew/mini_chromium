...
#ifndef MINI_CHROMIUM_CRBASE_PICKLE_H_
#define MINI_CHROMIUM_CRBASE_PICKLE_H_
...
class CRBASE_EXPORT PickleIterator {
 public:
  ...
  // after that.
  bool ReadBool(bool* result) CR_WARN_UNUSED_RESULT;
  bool ReadInt(int* result) CR_WARN_UNUSED_RESULT;
  bool ReadLong(long* result) CR_WARN_UNUSED_RESULT;
  bool ReadUInt16(uint16_t* result) CR_WARN_UNUSED_RESULT;
  bool ReadUInt32(uint32_t* result) CR_WARN_UNUSED_RESULT;
  bool ReadInt64(int64_t* result) CR_WARN_UNUSED_RESULT;
  bool ReadUInt64(uint64_t* result) CR_WARN_UNUSED_RESULT;
  bool ReadSizeT(size_t* result) CR_WARN_UNUSED_RESULT;
  bool ReadFloat(float* result) CR_WARN_UNUSED_RESULT;
  bool ReadDouble(double* result) CR_WARN_UNUSED_RESULT;
  bool ReadString(std::string* result) CR_WARN_UNUSED_RESULT;
  // The StringPiece data will only be valid for the lifetime of the message.
  bool ReadStringPiece(StringPiece* result) CR_WARN_UNUSED_RESULT;
  bool ReadString16(string16* result) CR_WARN_UNUSED_RESULT;
  // The StringPiece16 data will only be valid for the lifetime of the message.
  bool ReadStringPiece16(StringPiece16* result) CR_WARN_UNUSED_RESULT;
  ...
  bool ReadData(const char** data, int* length) CR_WARN_UNUSED_RESULT;
  ...
  bool ReadBytes(const char** data, int length) CR_WARN_UNUSED_RESULT;

  // A safer version of ReadInt() that checks for the result not being negative.
  // Use it for reading the object sizes.
  bool ReadLength(int* result) CR_WARN_UNUSED_RESULT {
  ...
  bool SkipBytes(int num_bytes) CR_WARN_UNUSED_RESULT {
...
class CRBASE_EXPORT Pickle {
 public:
  ...
  const T* headerT() const {
    CR_DCHECK_EQ(header_size_, sizeof(T));
...
#endif  // MINI_CHROMIUM_CRBASE_PICKLE_H_