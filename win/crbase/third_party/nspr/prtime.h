...
#ifndef MINI_CHROMIUM_CRBASE_PRTIME_H__
#define MINI_CHROMIUM_CRBASE_PRTIME_H__
...
CRBASE_EXPORT PRStatus PR_ParseTimeString (
	const char *string,
	PRBool default_to_gmt,
	PRTime *result);

#endif  //MINI_CHROMIUM_CRBASE_PRTIME_H__