...
#ifndef MINI_CHROMIUM_CRBASE_THIRD_PARTY_ICU_ICU_UTF_H_
#define MINI_CHROMIUM_CRBASE_THIRD_PARTY_ICU_ICU_UTF_H_
...
}  // namesapce crbase_icu

#endif  // MINI_CHROMIUM_CRBASE_THIRD_PARTY_ICU_ICU_UTF_H_