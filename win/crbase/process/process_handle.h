...
#ifndef MINI_CHROMIUM_CRBASE_PROCESS_PROCESS_HANDLE_H_
#define MINI_CHROMIUM_CRBASE_PROCESS_PROCESS_HANDLE_H_
...
#endif  // MINI_CHROMIUM_CRBASE_PROCESS_PROCESS_HANDLE_H_