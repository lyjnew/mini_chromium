...
#ifndef MINI_CHROMIUM_CRBASE_PROCESS_MEMORY_H_
#define MINI_CHROMIUM_CRBASE_PROCESS_MEMORY_H_
...
CRBASE_EXPORT CR_WARN_UNUSED_RESULT bool UncheckedMalloc(size_t size,
                                                         void** result);
CRBASE_EXPORT CR_WARN_UNUSED_RESULT bool UncheckedCalloc(size_t num_items,
                                                         size_t size,
                                                         void** result);

}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_PROCESS_MEMORY_H_