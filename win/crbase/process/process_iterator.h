...
#ifndef MINI_CHROMIUM_CRBASE_PROCESS_PROCESS_ITERATOR_H_
#define MINI_CHROMIUM_CRBASE_PROCESS_PROCESS_ITERATOR_H_
...
#endif  // MINI_CHROMIUM_CRBASE_PROCESS_PROCESS_ITERATOR_H_