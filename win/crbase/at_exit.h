...
#ifndef MINI_CHROMIUM_CRBASE_AT_EXIT_H_
#define MINI_CHROMIUM_CRBASE_AT_EXIT_H_
...
class CRBASE_EXPORT AtExitManager {
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(AtExitManager);
};

}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_AT_EXIT_H_