...
#ifndef MINI_CHROMIUM_CRBASE_TASK_RUNNER_H_
#define MINI_CHROMIUM_CRBASE_TASK_RUNNER_H_
...
class CRBASE_EXPORT TaskRunner
 ...
 public:
  ...
  virtual bool PostDelayedTask(const crtracked_objects::Location& from_here,
                               const Closure& task,
  ...
  //          CR_FROM_HERE,
  //          crbase::Bind(&DataBuffer::AddData, buffer),
  //          crbase::Bind(&DataLoader::OnDataReceived, AsWeakPtr(), buffer));
  //    }
  //
  //  private:
  ...
  //     WeakPtr<>.
  bool PostTaskAndReply(const crtracked_objects::Location& from_here,
                        const Closure& task,
                        const Closure& reply);
...
#endif  // MINI_CHROMIUM_CRBASE_TASK_RUNNER_H_