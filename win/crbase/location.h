...
#ifndef MINI_CHROMIUM_CRBASE_LOCATION_H_
#define MINI_CHROMIUM_CRBASE_LOCATION_H_
...
struct CRBASE_EXPORT LocationSnapshot {
  ...
  LocationSnapshot();
  explicit LocationSnapshot(const crtracked_objects::Location& location);
  ~LocationSnapshot();
...
#define CR_FROM_HERE CR_FROM_HERE_WITH_EXPLICIT_FUNCTION(__FUNCTION__)

#define CR_FROM_HERE_WITH_EXPLICIT_FUNCTION(function_name)                     \
    ::crtracked_objects::Location(function_name,                               \
                                __FILE__,                                      \
                                __LINE__,                                      \
...
#endif  // MINI_CHROMIUM_CRBASE_LOCATION_H_