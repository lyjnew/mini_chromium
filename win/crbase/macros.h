...
#ifndef MINI_CHROMIUM_CRBASE_MACROS_H_
#define MINI_CHROMIUM_CRBASE_MACROS_H_
...
#define cr_arraysize(array) (sizeof(CrArraySizeHelper(array)))
...
// thread-safe initialization, use crbase/lazy_instance.h instead.
#define CR_DEFINE_STATIC_LOCAL(type, name, arguments) \
  static type& name = *new type arguments

}  // crbase

#endif  // MINI_CHROMIUM_CRBASE_MACROS_H_