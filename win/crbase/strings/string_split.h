...
#ifndef MINI_CHROMIUM_CRBASE_STRINGS_STRING_SPLIT_H_
#define MINI_CHROMIUM_CRBASE_STRINGS_STRING_SPLIT_H_
...
#endif  // MINI_CHROMIUM_CRBASE_STRINGS_STRING_SPLIT_H_