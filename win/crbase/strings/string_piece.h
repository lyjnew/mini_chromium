...
#ifndef MINI_CHROMIUM_CRBASE_STRINGS_STRING_PIECE_H_
#define MINI_CHROMIUM_CRBASE_STRINGS_STRING_PIECE_H_
...
CRBASE_EXPORT void CopyToString(const StringPiece& self, std::string* target);
CRBASE_EXPORT void CopyToString(const StringPiece16& self, string16* target);

CRBASE_EXPORT void AppendToString(const StringPiece& self, std::string* target);
...
extern template class CRBASE_EXPORT BasicStringPiece<std::string>;
extern template class CRBASE_EXPORT BasicStringPiece<string16>;
#endif

// StingPiece operators --------------------------------------------------------

CRBASE_EXPORT bool operator==(const StringPiece& x, const StringPiece& y);
...
#endif  // MINI_CHROMIUM_CRBASE_STRINGS_STRING_PIECE_H_