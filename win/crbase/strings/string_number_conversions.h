...
#ifndef MINI_CHROMIUM_CRBASE_STRINGS_STRING_NUMBER_CONVERSIONS_H_
#define MINI_CHROMIUM_CRBASE_STRINGS_STRING_NUMBER_CONVERSIONS_H_
...
CRBASE_EXPORT bool StringToUint64(const StringPiece16& input, uint64_t* output);
...
CRBASE_EXPORT bool StringToDouble(const std::string& input, double* output);
...
// The string is not required to start with 0x.
CRBASE_EXPORT bool HexStringToUInt64(const StringPiece& input, 
                                     uint64_t* output);
...
CRBASE_EXPORT bool HexStringToBytes(const std::string& input,
                                    std::vector<uint8_t>* output);
 
}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_STRINGS_STRING_NUMBER_CONVERSIONS_H_