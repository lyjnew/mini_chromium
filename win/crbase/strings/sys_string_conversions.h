...
#ifndef MINI_CHROMIUM_CRBASE_STRINGS_SYS_STRING_CONVERSIONS_H_
#define MINI_CHROMIUM_CRBASE_STRINGS_SYS_STRING_CONVERSIONS_H_
...
#endif  // MINI_CHROMIUM_CRBASE_STRINGS_SYS_STRING_CONVERSIONS_H_