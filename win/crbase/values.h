...
#ifndef MINI_CHROMIUM_CRBASE_VALUES_H_
#define MINI_CHROMIUM_CRBASE_VALUES_H_
...
class CRBASE_EXPORT FundamentalValue : public Value {
 public:
...
class CRBASE_EXPORT StringValue : public Value {
 public:
...
class CRBASE_EXPORT BinaryValue: public Value {
 public:
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(BinaryValue);
};
...
class CRBASE_EXPORT DictionaryValue : public Value {
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(DictionaryValue);
};
...
class CRBASE_EXPORT ListValue : public Value {
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(ListValue);
};
...
#endif  // MINI_CHROMIUM_CRBASE_VALUES_H_