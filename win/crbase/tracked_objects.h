...
#ifndef MINI_CHROMIUM_CRBASE_TRACKED_OBJECTS_H_
#define MINI_CHROMIUM_CRBASE_TRACKED_OBJECTS_H_
...
class ThreadData;
class CRBASE_EXPORT BirthOnThread {
 public:
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(BirthOnThread);
};

//------------------------------------------------------------------------------
// A "snapshotted" representation of the BirthOnThread class.

struct CRBASE_EXPORT BirthOnThreadSnapshot {
...
class CRBASE_EXPORT Births: public BirthOnThread {
 public:
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(Births);
};

//------------------------------------------------------------------------------
// A "snapshotted" representation of the DeathData class.

struct CRBASE_EXPORT DeathDataSnapshot {
  DeathDataSnapshot();
...
struct CRBASE_EXPORT TaskSnapshot {
  TaskSnapshot();
...
class CRBASE_EXPORT TaskStopwatch;
...
class CRBASE_EXPORT ThreadData {
 public:
...
///  FRIEND_TEST_ALL_PREFIXES(TrackedObjectsTest, TinyStartupShutdown);
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(ThreadData);
};
...
struct CRBASE_EXPORT ProcessDataPhaseSnapshot {
 public:
...
struct CRBASE_EXPORT ProcessDataSnapshot {
 public:
  ProcessDataSnapshot();
  ~ProcessDataSnapshot();
...
#endif  // MINI_CHROMIUM_CRBASE_TRACKED_OBJECTS_H_