...
#ifndef MINI_CHROMIUM_CRBASE_AUTO_RESET_H_
#define MINI_CHROMIUM_CRBASE_AUTO_RESET_H_
...
class AutoReset {
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(AutoReset);
};

}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_AUTO_RESET_H_