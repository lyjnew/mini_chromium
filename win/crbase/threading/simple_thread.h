...
#ifndef MINI_CHROMIUM_CRBASE_THREADING_SIMPLE_THREAD_H_
#define MINI_CHROMIUM_CRBASE_THREADING_SIMPLE_THREAD_H_
...
class CRBASE_EXPORT DelegateSimpleThread : public SimpleThread {
 public:
...
class CRBASE_EXPORT DelegateSimpleThreadPool
 ...
 private:
  ...
  crbase::Lock lock_;    // Locks delegates_
  WaitableEvent dry_;    // Not signaled when there is no work to do.
};

}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_THREADING_SIMPLE_THREAD_H_