...
#ifndef MINI_CHROMIUM_CRBASE_THREADING_PLATFORM_THREAD_H_
#define MINI_CHROMIUM_CRBASE_THREADING_PLATFORM_THREAD_H_
...
class CRBASE_EXPORT PlatformThread {
 public:
  ...
  static void Sleep(crbase::TimeDelta duration);
 ...
 private:
  CR_DISALLOW_IMPLICIT_CONSTRUCTORS(PlatformThread);
};

}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_THREADING_PLATFORM_THREAD_H_