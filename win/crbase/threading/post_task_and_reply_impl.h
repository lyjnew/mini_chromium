...
#ifndef MINI_CHROMIUM_CRBASE_THREADING_POST_TASK_AND_REPLY_IMPL_H_
#define MINI_CHROMIUM_CRBASE_THREADING_POST_TASK_AND_REPLY_IMPL_H_
...
class PostTaskAndReplyImpl {
 ...
 private:
  virtual bool PostTask(const crtracked_objects::Location& from_here,
...
#endif  // MINI_CHROMIUM_CRBASE_THREADING_POST_TASK_AND_REPLY_IMPL_H_