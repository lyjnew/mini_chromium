...
#ifndef MINI_CHROMIUM_CRBASE_THREADING_THREAD_ID_NAME_MANAGER_H_
#define MINI_CHROMIUM_CRBASE_THREADING_THREAD_ID_NAME_MANAGER_H_
...
class CRBASE_EXPORT ThreadIdNameManager {
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(ThreadIdNameManager);
};

}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_THREADING_THREAD_ID_NAME_MANAGER_H_