...
//   MyClass::MyClass() {
//     CR_DCHECK(Singleton<ThreadLocalPointer<MyClass> >::get()->Get() == NULL);
...
class ThreadLocalPointer {
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(ThreadLocalPointer<Type>);
};
...
class ThreadLocalBoolean {
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(ThreadLocalBoolean);
};

}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_THREADING_THREAD_LOCAL_H_