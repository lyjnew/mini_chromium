...
///#include "crbase/metrics/field_trial.h"
#include "crbase/strings/string_number_conversions.h"
#include "crbase/strings/string_util.h"
#include "crbase/sys_info_internal.h"
...
static LazyInstance<
  ...
  g_lazy_low_end_device = CR_LAZY_INSTANCE_INITIALIZER;

// static
bool SysInfo::IsLowEndDevice() {
  ///const std::string group_name =
  ///    crbase::FieldTrialList::FindFullName("MemoryReduction");
...
// static
crbase::TimeDelta SysInfo::Uptime() {
  ...
  return crbase::TimeDelta::FromMicroseconds(uptime_in_microseconds);
}
