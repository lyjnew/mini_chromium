...
#ifndef MINI_CHROMIUM_CRBASE_PATH_SERVICE_H_
#define MINI_CHROMIUM_CRBASE_PATH_SERVICE_H_
...
//
class CRBASE_EXPORT PathService {
 public:
...
#endif  // MINI_CHROMIUM_CRBASE_PATH_SERVICE_H_