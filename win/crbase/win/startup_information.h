...
#ifndef MINI_CHROMIUM_CRBASE_WIN_STARTUP_INFORMATION_H_
#define MINI_CHROMIUM_CRBASE_WIN_STARTUP_INFORMATION_H_
...
class CRBASE_EXPORT StartupInformation {
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(StartupInformation);
};

}  // namespace win
}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_WIN_STARTUP_INFORMATION_H_