...
#ifndef MINI_CHROMIUM_CRBASE_WIN_WINDOWS_VERSION_H_
#define MINI_CHROMIUM_CRBASE_WIN_WINDOWS_VERSION_H_
...
enum Version {
  ...
  VERSION_WIN11,       // Also includes Windows 11 Server.
...
class CRBASE_EXPORT OSInfo {
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(OSInfo);
};
...
#endif  // MINI_CHROMIUM_CRBASE_WIN_WINDOWS_VERSION_H_