...
#ifndef MINI_CHROMIUM_CRBASE_WIN_OBJECT_WATCHER_H_
#define MINI_CHROMIUM_CRBASE_WIN_OBJECT_WATCHER_H_
...
//
class CRBASE_EXPORT ObjectWatcher : public MessageLoop::DestructionObserver {
 public:
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(ObjectWatcher);
};

}  // namespace win
}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_WIN_OBJECT_WATCHER_H_