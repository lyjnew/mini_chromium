...
#ifndef MINI_CHROMIUM_CRBASE_WIN_SCOPED_GDI_OBJECT_H_
#define MINI_CHROMIUM_CRBASE_WIN_SCOPED_GDI_OBJECT_H_
...
#endif  // MINI_CHROMIUM_CRBASE_WIN_SCOPED_GDI_OBJECT_H_