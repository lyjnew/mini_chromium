...
#ifndef MINI_CHROMIUM_CRBASE_WIN_SCOPED_OLE_INITIALIZER_H_
#define MINI_CHROMIUM_CRBASE_WIN_SCOPED_OLE_INITIALIZER_H_
...
class CRBASE_EXPORT ScopedOleInitializer {
 public:
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(ScopedOleInitializer);
};

}  // namespace win
}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_WIN_SCOPED_OLE_INITIALIZER_H_