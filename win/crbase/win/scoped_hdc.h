...
#ifndef MINI_CHROMIUM_CRBASE_WIN_SCOPED_HDC_H_
#define MINI_CHROMIUM_CRBASE_WIN_SCOPED_HDC_H_
...
class ScopedGetDC {
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(ScopedGetDC);
};
...
class CreateDCTraits {
 ...
 private:
  CR_DISALLOW_IMPLICIT_CONSTRUCTORS(CreateDCTraits);
};
...
#endif  // MINI_CHROMIUM_CRBASE_WIN_SCOPED_HDC_H_