...
#ifndef MINI_CHROMIUM_CRBASE_WIN_SCOPED_PROCESS_INFORMATION_H_
#define MINI_CHROMIUM_CRBASE_WIN_SCOPED_PROCESS_INFORMATION_H_
...
class CRBASE_EXPORT ScopedProcessInformation {
 public:
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(ScopedProcessInformation);
};

}  // namespace win
}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_WIN_SCOPED_PROCESS_INFORMATION_H_