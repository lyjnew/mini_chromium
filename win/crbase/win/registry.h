...
#ifndef MINI_CHROMIUM_CRBASE_WIN_REGISTRY_H_
#define MINI_CHROMIUM_CRBASE_WIN_REGISTRY_H_
...
class CRBASE_EXPORT RegKey {
 ...
 private:
  ...
  REGSAM wow64access_;
  ///crbase::scoped_ptr<Watcher> key_watcher_;

  CR_DISALLOW_COPY_AND_ASSIGN(RegKey);
};
...
#endif  // MINI_CHROMIUM_CRBASE_WIN_REGISTRY_H_