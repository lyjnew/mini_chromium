...
#ifndef MINI_CHROMIUM_CRBASE_WIN_SCOPED_PROPVARIANT_H_
#define MINI_CHROMIUM_CRBASE_WIN_SCOPED_PROPVARIANT_H_
...
#endif  // MINI_CHROMIUM_CRBASE_WIN_SCOPED_PROPVARIANT_H_