...
#ifndef MINI_CHROMIUM_CRBASE_WIN_SCOPED_COMPTR_H_
#define MINI_CHROMIUM_CRBASE_WIN_SCOPED_COMPTR_H_
...
class ScopedComPtr : public scoped_refptr<Interface> {
 public:
  ...
  // Usage: Foo(p.Receive());
  Interface** Receive() {
    CR_DCHECK(!this->ptr_) << "Object leak. Pointer must be NULL";
    return &this->ptr_;
  }
...
#endif  // MINI_CHROMIUM_CRBASE_WIN_SCOPED_COMPTR_H_