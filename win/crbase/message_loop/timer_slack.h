...
#ifndef MINI_CHROMIUM_CRBASE_MESSAGE_LOOP_TIMER_SLACK_H_
#define MINI_CHROMIUM_CRBASE_MESSAGE_LOOP_TIMER_SLACK_H_
...
#endif  // MINI_CHROMIUM_CRBASE_MESSAGE_LOOP_TIMER_SLACK_H_