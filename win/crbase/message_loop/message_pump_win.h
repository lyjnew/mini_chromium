...
#ifndef MINI_CHROMIUM_CRBASE_MESSAGE_LOOP_MESSAGE_PUMP_WIN_H_
#define MINI_CHROMIUM_CRBASE_MESSAGE_LOOP_MESSAGE_PUMP_WIN_H_
...
#endif  // MINI_CHROMIUM_CRBASE_MESSAGE_LOOP_MESSAGE_PUMP_WIN_H_