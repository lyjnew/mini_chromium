...
#ifndef MINI_CHROMIUM_CRBASE_MESSAGE_LOOP_INCOMING_TASK_QUEUE_H_
#define MINI_CHROMIUM_CRBASE_MESSAGE_LOOP_INCOMING_TASK_QUEUE_H_
...
class CRBASE_EXPORT IncomingTaskQueue
 ...
 public:
  ...
  // called method.
  bool AddToIncomingQueue(const crtracked_objects::Location& from_here,
                          const Closure& task,
                          TimeDelta delay,
                          bool nestable);
 ...
 private:
  ...
  CR_DISALLOW_COPY_AND_ASSIGN(IncomingTaskQueue);
};

}  // namespace internal
}  // namespace crbase

#endif  // MINI_CHROMIUM_CRBASE_MESSAGE_LOOP_INCOMING_TASK_QUEUE_H_