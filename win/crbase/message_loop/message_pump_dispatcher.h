...
#ifndef MINI_CHROMIUM_CRBASE_MESSAGE_LOOP_MESSAGE_PUMP_DISPATCHER_H_
#define MINI_CHROMIUM_CRBASE_MESSAGE_LOOP_MESSAGE_PUMP_DISPATCHER_H_
...
class CRBASE_EXPORT MessagePumpDispatcher {
 public:
...
#endif  // MINI_CHROMIUM_CRBASE_MESSAGE_LOOP_MESSAGE_PUMP_DISPATCHER_H_