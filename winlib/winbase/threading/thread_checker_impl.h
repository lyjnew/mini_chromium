...
#ifndef WINLIB_WINBASE_THREADING_THREAD_CHECKER_IMPL_H_
#define WINLIB_WINBASE_THREADING_THREAD_CHECKER_IMPL_H_
...
class WINBASE_EXPORT ThreadCheckerImpl {
 public:
  ThreadCheckerImpl();
  ~ThreadCheckerImpl();
...
#endif  // WINLIB_WINBASE_THREADING_THREAD_CHECKER_IMPL_H_