...
#ifndef WINLIB_WINBASE_THREADING_SEQUENCE_LOCAL_STORAGE_SLOT_H_
#define WINLIB_WINBASE_THREADING_SEQUENCE_LOCAL_STORAGE_SLOT_H_
...
namespace internal {
WINBASE_EXPORT int GetNextSequenceLocalStorageSlotNumber();
}
...
//
// namespace {
// winbase::LazyInstance<SequenceLocalStorageSlot<int>> sls_value;
// }
//
// void Read() {
...
#endif  // WINLIB_WINBASE_THREADING_SEQUENCE_LOCAL_STORAGE_SLOT_H_