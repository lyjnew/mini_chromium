...
#ifndef WINLIB_WINBASE_THREADING_PLATFORM_THREAD_H_
#define WINLIB_WINBASE_THREADING_PLATFORM_THREAD_H_
...
class WINBASE_EXPORT PlatformThread {
 public:
  ...
  static void Sleep(winbase::TimeDelta duration);
...
#endif  // WINLIB_WINBASE_THREADING_PLATFORM_THREAD_H_