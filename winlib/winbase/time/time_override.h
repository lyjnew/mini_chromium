...
#ifndef WINLIB_WINBASE_TIME_TIME_OVERRIDE_H_
#define WINLIB_WINBASE_TIME_TIME_OVERRIDE_H_
...
class WINBASE_EXPORT ScopedTimeClockOverrides {
 public:
  // Pass |nullptr| for any override if it shouldn't be overriden.
  explicit ScopedTimeClockOverrides(
  ...
  ScopedTimeClockOverrides() = delete;
...
// override time.
WINBASE_EXPORT Time TimeNowIgnoringOverride();
WINBASE_EXPORT Time TimeNowFromSystemTimeIgnoringOverride();
WINBASE_EXPORT TimeTicks TimeTicksNowIgnoringOverride();
WINBASE_EXPORT ThreadTicks ThreadTicksNowIgnoringOverride();
...
#endif  // WINLIB_WINBASE_TIME_TIME_OVERRIDE_H_