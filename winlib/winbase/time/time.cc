...
#include "winbase\third_party\nspr/prtime.h"
#include "winbase\time\time_override.h"
...
Time Time::FromJavaTime(int64_t ms_since_epoch) {
  return winbase::Time::UnixEpoch() +
         winbase::TimeDelta::FromMilliseconds(ms_since_epoch);
}
...
TimeTicks TimeTicks::UnixEpoch() {
  static const winbase::NoDestructor<winbase::TimeTicks> epoch([]() {
