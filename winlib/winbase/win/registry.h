...
#ifndef WINLIB_WINBASE_WIN_REGISTRY_H_
#define WINLIB_WINBASE_WIN_REGISTRY_H_
...
class WINBASE_EXPORT RegKey {
 public:
  // Called from the MessageLoop when the key changes.
  typedef winbase::Callback<void()> ChangeCallback;
...
class WINBASE_EXPORT RegistryValueIterator {
 public:
...
class WINBASE_EXPORT RegistryKeyIterator {
 public:
...
#endif  // WINLIB_WINBASE_WIN_REGISTRY_H_