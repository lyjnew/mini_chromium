...
#ifndef WINLIB_WINBASE_FILES_SCOPED_TEMP_DIR_H_
#define WINLIB_WINBASE_FILES_SCOPED_TEMP_DIR_H_
...
class WINBASE_EXPORT ScopedTempDir {
 public:
...
#endif  // WINLIB_WINBASE_FILES_SCOPED_TEMP_DIR_H_