...
#ifndef WINLIB_WINBASE_FILES_IMPORTANT_FILE_WRITER_H_
#define WINLIB_WINBASE_FILES_IMPORTANT_FILE_WRITER_H_
...
class WINBASE_EXPORT ImportantFileWriter {
 public:
  // Used by ScheduleSave to lazily provide the data to be saved. Allows us
  // to also batch data serializations.
  class WINBASE_EXPORT DataSerializer {
   public:
...
#endif  // WINLIB_WINBASE_FILES_IMPORTANT_FILE_WRITER_H_