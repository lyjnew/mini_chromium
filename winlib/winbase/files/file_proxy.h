...
#ifndef WINLIB_WINBASE_FILES_FILE_PROXY_H_
#define WINLIB_WINBASE_FILES_FILE_PROXY_H_
...
class WINBASE_EXPORT FileProxy : public SupportsWeakPtr<FileProxy> {
 public:
...
#endif  // WINLIB_WINBASE_FILES_FILE_PROXY_H_