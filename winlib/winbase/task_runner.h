...
#ifndef WINLIB_WINBASE_TASK_RUNNER_H_
#define WINLIB_WINBASE_TASK_RUNNER_H_
...
class WINBASE_EXPORT TaskRunner
 ...
 public:
  ...
  //          WINBASE_FROM_HERE,
  //          winbase::Bind(&DataBuffer::AddData, buffer),
  //          winbase::Bind(&DataLoader::OnDataReceived, AsWeakPtr(), buffer));
  //    }
  //
  //  private:
...
struct WINBASE_EXPORT TaskRunnerTraits {
  static void Destruct(const TaskRunner* task_runner);
};

}  // namespace winbase

#endif  // WINLIB_WINBASE_TASK_RUNNER_H_