...
#ifndef WINLIB_WINBASE_STRINGS_STRING_PIECE_H_
#define WINLIB_WINBASE_STRINGS_STRING_PIECE_H_
...
#include "winbase\strings\char_traits.h"
...
WINBASE_EXPORT void CopyToString(const StringPiece& self, std::string* target);
WINBASE_EXPORT void CopyToString(const StringPiece16& self, string16* target);

WINBASE_EXPORT void AppendToString(const StringPiece& self, std::string* target);
WINBASE_EXPORT void AppendToString(const StringPiece16& self, string16* target);

WINBASE_EXPORT size_t copy(const StringPiece& self,
                           char* buf,
                           size_t n,
                           size_t pos);
WINBASE_EXPORT size_t copy(const StringPiece16& self,
                           char16* buf,
                           size_t n,
                           size_t pos);

WINBASE_EXPORT size_t find(const StringPiece& self,
                           const StringPiece& s,
                           size_t pos);
WINBASE_EXPORT size_t find(const StringPiece16& self,
...
WINBASE_EXPORT size_t rfind(const StringPiece& self,
                            const StringPiece& s,
                            size_t pos);
WINBASE_EXPORT size_t rfind(const StringPiece16& self,
                            const StringPiece16& s,
                            size_t pos);
WINBASE_EXPORT size_t rfind(const StringPiece& self,
                            char c,
...
WINBASE_EXPORT size_t find_first_of(const StringPiece& self,
                                    const StringPiece& s,
                                    size_t pos);
WINBASE_EXPORT size_t find_first_of(const StringPiece16& self,
                                    const StringPiece16& s,
                                    size_t pos);

WINBASE_EXPORT size_t find_first_not_of(const StringPiece& self,
                                        const StringPiece& s,
                                        size_t pos);
WINBASE_EXPORT size_t find_first_not_of(const StringPiece16& self,
                                        const StringPiece16& s,
                                        size_t pos);
WINBASE_EXPORT size_t find_first_not_of(const StringPiece& self,
                                        char c,
...
WINBASE_EXPORT size_t find_last_of(const StringPiece& self,
                                   const StringPiece& s,
                                   size_t pos);
WINBASE_EXPORT size_t find_last_of(const StringPiece16& self,
                                   const StringPiece16& s,
                                   size_t pos);
WINBASE_EXPORT size_t find_last_of(const StringPiece& self,
                                   char c,
...
WINBASE_EXPORT size_t find_last_not_of(const StringPiece& self,
                                       const StringPiece& s,
                                       size_t pos);
WINBASE_EXPORT size_t find_last_not_of(const StringPiece16& self,
                                       const StringPiece16& s,
                                       size_t pos);
WINBASE_EXPORT size_t find_last_not_of(const StringPiece16& self,
                                       char16 c,
...
WINBASE_EXPORT StringPiece substr(const StringPiece& self,
                                  size_t pos,
                                  size_t n);
WINBASE_EXPORT StringPiece16 substr(const StringPiece16& self,
                                    size_t pos,
                                    size_t n);

///#if WINBASE_DCHECK_IS_ON()
///// Asserts that begin <= end to catch some errors with iterator usage.
///WINBASE_EXPORT void AssertIteratorsInOrder(std::string::const_iterator begin,
///                                           std::string::const_iterator end);
///WINBASE_EXPORT void AssertIteratorsInOrder(string16::const_iterator begin,
...
extern template class WINBASE_EXPORT BasicStringPiece<std::string>;
extern template class WINBASE_EXPORT BasicStringPiece<string16>;
#endif

// StingPiece operators --------------------------------------------------------

WINBASE_EXPORT bool operator==(const StringPiece& x, const StringPiece& y);
...
WINBASE_EXPORT std::ostream& operator<<(std::ostream& o,
...
#define WINBASE_HASH_STRING_PIECE(StringPieceType, string_piece) \
  std::size_t result = 0;                                        \
...
struct StringPieceHash {
  std::size_t operator()(const StringPiece& sp) const {
    WINBASE_HASH_STRING_PIECE(StringPiece, sp);
  }
};
struct StringPiece16Hash {
  std::size_t operator()(const StringPiece16& sp16) const {
    WINBASE_HASH_STRING_PIECE(StringPiece16, sp16);
  }
};

#undef WINBASE_HASH_STRING_PIECE

}  // namespace winbase

#endif  // WINLIB_WINBASE_STRINGS_STRING_PIECE_H_