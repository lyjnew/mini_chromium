...
inline int vsnprintfT(char* buffer,
                      ...
                      const char* format,
                      va_list argptr) {
  return winbase::vsnprintf(buffer, buf_size, format, argptr);
}
...
inline int vsnprintfT(wchar_t* buffer,
                      ...
                      va_list argptr) {
  return winbase::vswprintf(buffer, buf_size, format, argptr);
}
...
static void StringAppendVT(StringType* dst,
  ...
  int result = vsnprintfT(stack_buf, array_size(stack_buf), format, ap_copy);
  va_end(ap_copy);
