...
#ifndef WINLIB_WINBASE_SINGLE_THREAD_TASK_RUNNER_H_
#define WINLIB_WINBASE_SINGLE_THREAD_TASK_RUNNER_H_
...
class WINBASE_EXPORT SingleThreadTaskRunner : public SequencedTaskRunner {
 public:
...
#endif  // WINLIB_WINBASE_SINGLE_THREAD_TASK_RUNNER_H_