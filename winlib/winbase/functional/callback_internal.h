...
// function pointer.
class WINBASE_EXPORT BindStateBase
    : public RefCountedThreadSafe<BindStateBase, BindStateBaseRefCountTraits> {
 public:
  WINBASE_REQUIRE_ADOPTION_FOR_REFCOUNTED_TYPE();
 ...
 private:
  ...
  friend struct ::winbase::FakeBindState;
...
class WINBASE_EXPORT CallbackBase {
 public:
...
class WINBASE_EXPORT CallbackBaseCopyable : public CallbackBase {
 public:
