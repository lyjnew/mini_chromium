...
#ifndef WINLIB_WINBASE_PROCESS_PROCESS_H_
#define WINLIB_WINBASE_PROCESS_PROCESS_H_
...
class WINBASE_EXPORT Process {
 public:
  ...
  bool IsRunning() const {
    return !WaitForExitWithTimeout(winbase::TimeDelta(), nullptr);
  }
...
#endif  // WINLIB_WINBASE_PROCESS_PROCESS_H_